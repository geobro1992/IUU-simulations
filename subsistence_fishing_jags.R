#########################################################
# subsistence fishing (model assumes no unreported harvest)

cat(file="subsistence_baseline.txt", " 
    model {
    #priors
...
########################################################################################
# subsistence fishing (model assumes some unreported harvest that changes with abundance)

cat(file="subsistence_with_unreported.txt", " 
    model {
    #priors
...
cat(file="subsistence_all_unreported.txt", " 
    model {
    #priors
